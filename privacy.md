...
services you have requested. This will include fulfilling any agreement you may
have with us (or our representatives), and providing you with information about
...
3. provide you with suggestions and advice on products, services and how to obtain
...
provide class information, for example to monitor our performance with respect
to a particular service we provide. If we use it for this purpose, you as an
...
information about our business, including job opportunities and our products and
...
If you have given us explicit permission to do so, we may from time to time pass
...
so, you may not be able to use our website or our services further.
...
----------------------------------------------
If a Payment is made via PayPal the payment information is never taken by us or
transferred to us either through our website or otherwise. Our employees and
contractors never have access to it. At the point of payment, you are
transferred to a secure page on the website of PayPal


If a Payment is made via a credit or debit card we store information about your
debit or credit card or other means of payment when you first provide it to us.


We store this payment information in order to make repeat purchasing of goods
and services easier next time you visit our website or if you have opted for
recurring billing.
...
It allows us to recognise visitors that you have referred to us, and to credit
to you commission due for such referrals. It also includes information that
...
We record information such as your IP address. We also record information about
the software you are using to browse our website, such as the type of computer
...
as set out in this notice), we sometimes receive data that is indirectly made up
...
agents or other companies working for them may use technology that automatically
...
For example, some software our website uses may have been developed in
...
you may do so anytime by cancelling your account.
...
2. If you are under 16 you can only use our website for research purposes i.e. a school project and only with consent from a parent or guardian
3. We collect data about all users of and visitors to our website regardless of age, and we anticipate that some of those users and visitors will be children.
4. Such child users and visitors will inevitably visit different parts of the site and will be subject to whatever on-site marketing they find, wherever they visit.
